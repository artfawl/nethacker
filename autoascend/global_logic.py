    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: leaving dungeon level 1 at XP 5 avoids lethal, food-heavy farming and
                # reaches deeper monsters soon enough to gain the remaining experience efficiently.
