    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: leaving the level-1 XP farm once an established character is out of food will
                # prevent otherwise-certain starvation and expose it to fresh food and progression downstairs.
