    ...
    for item in agent.inventory.items:
        ...
        for y, x, monster, p in simulate_wand_path(agent, item, monsters, dy, dx):
            ...
            if monster == 'pet':
                ...
                peaceful_in_path = True
        # hypothesis: rejecting offensive wand lines that cross a peaceful monster prevents
        # avoidable Minetown hostility without weakening ordinary cross-identity combat.
        if targeted_monsters and not peaceful_in_path:
